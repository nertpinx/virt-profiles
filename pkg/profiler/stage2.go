...
// TranslateSpecs implements the stage2, translating the stage1 domain specification into the stage3 format
func (p *Profiler) TranslateSpecs(domSpec *k6tv1.DomainSpec) (*libvirtxml.Domain, error) {
